...
var indexviewmodel = {
	...
	recentSearchClicked:function(item){
		...
		if(item.index == 1){
			...
			indexviewmodel.fontfamily('mngltitleaat');
			indexviewmodel.enableRightAlign(false);
			
			$('#footernavbar li:eq(0) a').html('<a href="#" data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="span" data-theme="a" data-inline="true" class="ui-btn ui-btn-up-a ui-btn-inline"><span class="ui-btn-inner"><span class="ui-btn-text"> </span></span></a>');
			$('#footernavbar li:eq(1) a').html('<a href="#" data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="span" data-theme="a" data-inline="true" class="ui-btn ui-btn-up-a ui-btn-inline"><span class="ui-btn-inner"><span class="ui-btn-text"></span></span></a>');
			$('#footernavbar li:eq(2) a').html('<a href="#" data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="span" data-theme="a" data-inline="true" class="ui-btn ui-btn-up-a ui-btn-inline"><span class="ui-btn-inner"><span class="ui-btn-text">     </span></span></a>');
			$('#footernavbar li:eq(3) a').html('<a href="#" data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="span" data-theme="a" data-inline="true" class="ui-btn ui-btn-up-a ui-btn-inline"><span class="ui-btn-inner"><span class="ui-btn-text">  </span></span></a>');
			indexviewmodel.languagelist(
				[
					{name:'      ',index:0},
					{name:'    ',index:1},
